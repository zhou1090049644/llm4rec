...
class BaselineModel(torch.nn.Module):
    ...
    def feat2emb(self, seq, feature_array, mask=None, include_user=False):
        ...
        # print("Start processing features to embeddings...")
        ...
        # print(f"len(self.ITEM_EMB_FEAT) keys: {self.ITEM_EMB_FEAT.keys()}")
        for k in self.ITEM_EMB_FEAT:
    ...
    def forward(
        self, user_item, pos_seqs, neg_seqs, mask, next_mask, seq_feature, pos_feature, neg_feature
    ):
        """
        训练时调用，计算正负样本的logits
        ...
        """
        # print("===== Debug Info =====")
        # print("Start log2feats...")
        log_feats = self.log2feats(user_item, mask, seq_feature)
        # print("End log2feats...")
        loss_mask = (next_mask == 1).to(self.dev)

        # print("Start feat2emb for pos...")
        pos_embs = self.feat2emb(pos_seqs, pos_feature, include_user=False)
        # print("End feat2emb for pos...")
        # print("Start feat2emb for neg...")
        neg_embs = self.feat2emb(neg_seqs, neg_feature, include_user=False)
        # print("End feat2emb for neg...")
